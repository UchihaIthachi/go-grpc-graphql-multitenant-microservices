...
func (ec *executionContext) _Order_products(ctx context.Context, field graphql.CollectedField, obj *Order) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNOrderedProduct2ᚕgithubᚗcomᚋUchihaIthachiᚋgoᚑgrpcᚑgraphqlᚑmultitenantᚑmicroservicesᚋapiᚑgatewayᚐOrderedProductᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNOrderedProduct2githubᚗcomᚋUchihaIthachiᚋgoᚑgrpcᚑgraphqlᚑmultitenantᚑmicroservicesᚋapiᚑgatewayᚐOrderedProduct(ctx context.Context, sel ast.SelectionSet, v OrderedProduct) graphql.Marshaler {
	return ec._OrderedProduct(ctx, sel, &v)
}

func (ec *executionContext) marshalNOrderedProduct2ᚕgithubᚗcomᚋUchihaIthachiᚋgoᚑgrpcᚑgraphqlᚑmultitenantᚑmicroservicesᚋapiᚑgatewayᚐOrderedProductᚄ(ctx context.Context, sel ast.SelectionSet, v []OrderedProduct) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrderedProduct2githubᚗcomᚋUchihaIthachiᚋgoᚑgrpcᚑgraphqlᚑmultitenantᚑmicroservicesᚋapiᚑgatewayᚐOrderedProduct(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
