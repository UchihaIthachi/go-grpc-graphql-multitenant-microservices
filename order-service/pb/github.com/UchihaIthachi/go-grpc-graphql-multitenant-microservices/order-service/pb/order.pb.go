...
const file_order_proto_rawDesc = "" +
	...
	"totalPrice\x125\n" +
	"\bproducts\x18\x05 \x03(\v2\x19.order.Order.OrderProductR\bproducts\x1a\x86\x01\n" +
	...
	"\x13GetOrdersForAccount\x12!.order.GetOrdersForAccountRequest\x1a\".order.GetOrdersForAccountResponse\"\x00BUZSgithub.com/UchihaIthachi/go-grpc-graphql-multitenant-microservices/order-service/pbb\x06proto3"
...
var file_order_proto_goTypes = []any{
	...
	(*PostOrderRequest)(nil),              // 1: order.PostOrderRequest
