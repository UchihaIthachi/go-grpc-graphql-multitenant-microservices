...
const (
	OrderService_PostOrder_FullMethodName           = "/order.OrderService/PostOrder"
	OrderService_GetOrdersForAccount_FullMethodName = "/order.OrderService/GetOrdersForAccount"
)
